package net.mcreator.adastrafatalsqolcrafting;
...
@Mod("ad_astra_fatals_qol_crafting")
public class AdAstraFatalsQolCraftingMod {
	public static final Logger LOGGER = LogManager.getLogger(AdAstraFatalsQolCraftingMod.class);
	public static final String MODID = "ad_astra_fatals_qol_crafting";

	public AdAstraFatalsQolCraftingMod(IEventBus modEventBus) {
